...
class RigPickerTool(QtWidgets.QMainWindow):
    ...
    def mirror_selected_button(self):
        ...
        if not cmds.objExists(mirrored_controller):
            QtWidgets.QMessageBox.warning(self, "Warning", f"Mirrored controller '{mirrored_controller}' does not exist in the scene.")
            return
        ...
        QtWidgets.QMessageBox.information(self, "Success", f"Mirrored button created for '{mirrored_controller}'.")
