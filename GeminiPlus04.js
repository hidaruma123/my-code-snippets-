...
class PickerButton(QtWidgets.QPushButton):
    ...
    def __init__(self, controller, color, shape, width, height, parent=None):
        ...
        self.setFixedSize(self.width, self.height) # 個別のサイズを設定
...
class RigPickerTool(QtWidgets.QMainWindow):
    def __init__(self, parent=get_maya_main_window()):
        ...
        self.on_shape_changed() # 初期UI状態を設定
    ...
    def create_widgets(self):
        ...
        # ★★★ UIの変更: QFormLayoutを使うことでラベルとウィジェットのペアを管理しやすくする ★★★
        ...
        self.width_label = QtWidgets.QLabel("Size:") # ラベルもインスタンス変数にする
    ...
    def load_picker(self):
        ...
        for btn_data in data.get('buttons', []):
            # ★★★ 後方互換性を持たせてwidthとheightを読み込み ★★★
            size = btn_data.get('size', 40) # 古いキー'size'があればそれを使い、なければデフォルト値
