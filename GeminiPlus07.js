...
class RigPickerTool(QtWidgets.QMainWindow):
    def __init__(self, parent=get_maya_main_window()):
        ...
        # ★★★ 背景画像の固定サイズを保持する変数を追加 ★★★
        self.fixed_background_size = QtCore.QSize(800, 600)  # デフォルトサイズ
    ...
    def create_widgets(self):
        ...
        # ★★★ スクロールエリアを追加して固定サイズの背景を実現 ★★★
        self.scroll_area = QtWidgets.QScrollArea()
        self.scroll_area.setWidgetResizable(False)  # 重要: Falseに設定
